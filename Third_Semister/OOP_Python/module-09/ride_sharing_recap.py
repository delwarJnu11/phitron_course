...
# class Driver(User):
#     def __init__(self, name, email, nid, wallet, current_location) -> None:
#         self.wallet = wallet
...
#     def __repr__(self):
#         print(f'Ride start from {self.start_location} to {self.end_location}')
...
# alice = Driver("Alice", "alaice@gmil.com", 12345, 1000, "Chittagong 1")
# sakib = Rider("Sakib", "sakib@gmail.com", 1236, 5000, "Chittagong 2")
